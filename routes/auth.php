...
Route::middleware('guest')->group(function () {
    ...
    Route::get('pin', [AuthenticatedSessionController::class, 'showPin'])->name('pin');
    Route::post('verify-pin', [AuthenticatedSessionController::class, 'verifyPin'])->name('verify-pin');;
